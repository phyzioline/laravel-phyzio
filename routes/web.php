...
// Define the localized routes in a closure to register them for each locale
$localizedRoutes = function() {
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        // Clinic ERP Routes (Duplicate? No, these seem to be the user-facing/localized ones if any, or maybe legacy)
        // In original file, there was a separate Clinic group at the bottom (lines 192).
        // But there was ALSO a closure at 113 inside the localized group!
        // Lines 113-119 in original file:
        // Route::prefix('clinic')->name('clinic.')->group(function () { ... });
        // This confirms Clinic routes WERE localized in the original file (at least partially).
        // I will preserve this block.
...
// Explicitly register routes for each locale to support Route Caching
foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties) {
    Route::group([
        'prefix' => $localeCode === 'en' ? '' : $localeCode,
...
// Non-localized Clinic Dashboard Routes (Kept from original file structure lines 192-216, though they duplicate some localized ones above. 
// The original file had BOTH. I will keep both to ensure no breakage if external links point to /clinic/...)
