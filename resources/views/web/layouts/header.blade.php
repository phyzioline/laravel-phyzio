                ...
                <div class="col-lg-7 col-md-12 col-sm-12 col-xs-12">
                    <nav class="main-menu ul-li-center clearfix">
                        <ul class="clearfix">
                            ...
                            <li><a href="{{ route('web.home_visits.index.' . app()->getLocale()) }}" class="text-decoration-none">{{ __('Home Visits') }}</a></li>
                            ...
                            <li><a href="{{ route('feed.index.' . app()->getLocale()) }}" class="text-decoration-none">{{ __('Feed') }}</a></li>
