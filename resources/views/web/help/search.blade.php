        ...
        <div class="col-lg-8">
            @if(count($results) > 0)
                <div class="list-group shadow-sm">
                    @foreach($results as $result)
                        <a href="{{ route('help.' . app()->getLocale() . '.article', ['category' => $result['category_slug'], 'article' => $result['article_slug']]) }}" class="list-group-item list-group-item-action p-4 border-left-0 border-right-0">
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <a href="{{ route('help.' . app()->getLocale() . '.index') }}" class="btn btn-primary px-4 rounded-pill" style="background-color: #02767F; border-color: #02767F;">
