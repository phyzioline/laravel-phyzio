        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="row">
                 ...
                 <form action="{{ route('instructor.courses.update', ['course' => $course->id, 'step' => 4]) }}" method="POST" class="mt-4">
                    @csrf
                    @method('PUT')
                    <div class="d-flex justify-content-between border-top pt-3">
                        <a href="{{ route('instructor.courses.edit', ['course' => $course->id, 'step' => 3]) }}" class="btn btn-light px-4 btn-lg">
