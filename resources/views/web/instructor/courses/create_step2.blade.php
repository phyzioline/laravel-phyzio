        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between border-top pt-3 mt-4">
                    <a href="{{ route('instructor.courses.edit', ['course' => $course->id, 'step' => 1]) }}" class="btn btn-light px-4 btn-lg">
                        <i class="las la-arrow-left mr-2"></i> {{ __('Back') }}
                    </a>
                    <a href="{{ route('instructor.courses.edit', ['course' => $course->id, 'step' => 3]) }}" class="btn btn-primary px-4 btn-lg">
