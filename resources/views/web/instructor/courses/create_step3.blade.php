...
<div class="row justify-content-center">
    <div class="col-lg-10">
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                <form action="{{ route('instructor.' . app()->getLocale() . '.courses.update.' . app()->getLocale(), ['course' => $course->id, 'step' => 3]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="d-flex justify-content-between border-top pt-3">
                        <a href="{{ route('instructor.' . app()->getLocale() . '.courses.edit.' . app()->getLocale(), ['course' => $course->id, 'step' => 2]) }}" class="btn btn-light px-4 btn-lg">
