...
<div class="row justify-content-center">
    <div class="col-lg-10">
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                <form action="{{ isset($course) ? route('instructor.courses.update', ['course' => $course->id, 'step' => 1]) : route('instructor.courses.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
