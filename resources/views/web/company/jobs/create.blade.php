            ...
            <div class="card-body p-4">
                <form action="{{ route('company.jobs.store') }}" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="title" class="form-control" placeholder="e.g. Senior Physiotherapist" required value="{{ old('title') }}">
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="location" class="form-control" placeholder="e.g. Cairo, Maadi" value="{{ old('location') }}">
                    </div>

                    <div class="form-group mb-3">
                        <label>Description <span class="text-danger">*</span></label>
                        <textarea name="description" class="form-control" rows="5" required placeholder="Describe the role responsibilities...">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="min_years_experience" class="form-control" min="0" value="{{ old('min_years_experience', 0) }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="salary_range" class="form-control" placeholder="e.g. 6000 - 8000 EGP or 100 EGP/Session" value="{{ old('salary_range') }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" name="openings_count" class="form-control" value="{{ old('openings_count', 1) }}" min="1" style="max-width: 150px;">
                    </div>
