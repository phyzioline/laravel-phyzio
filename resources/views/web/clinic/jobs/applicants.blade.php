...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('clinic.jobs.index') }}" class="btn btn-outline-secondary"><i class="las la-arrow-left"></i> Back to Jobs</a>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <span class="badge badge-secondary">{{ $app->match_score }}%</span>
                                    @endif
                                </td>
                                <td>
                                ...
                                <td>
                                    {{-- Actions: View Profile, Message, etc. --}}
                                    {{-- For now just a link (mock) --}}
