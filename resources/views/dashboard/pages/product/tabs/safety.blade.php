    ...
    <div class="row mb-3">
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="country_of_origin" 
                   placeholder="{{ __('e.g., China, Egypt') }}" value="{{ old('country_of_origin') }}">
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            ...
            <textarea class="form-control" name="warranty_description" rows="3" 
                      placeholder="{{ __('e.g., 2 Year Manufacturer Warranty') }}">{{ old('warranty_description', 'No Warranty') }}</textarea>
        ...
        <div class="col-md-6">
            ...
            <textarea class="form-control" name="seller_warranty_description" rows="3" 
                      placeholder="{{ __('e.g., 1 year warranty on parts and labor') }}">{{ old('seller_warranty_description') }}</textarea>
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="batteries_required" id="batteries_yes" value="1" {{ old('batteries_required') == '1' ? 'checked' : '' }}>
                <label class="form-check-label" for="batteries_yes">{{ __('Yes') }}</label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="batteries_required" id="batteries_no" value="0" {{ old('batteries_required', '0') == '0' ? 'checked' : '' }}>
        ...
        <div class="col-md-6" id="battery-details" style="display: {{ old('batteries_required') == '1' ? 'block' : 'none' }};">
            <label class="form-label">{{ __('Battery IEC Code') }}</label>
            <input type="text" class="form-control" name="battery_iec_code" 
                   placeholder="{{ __('e.g., CR2320') }}" value="{{ old('battery_iec_code') }}">
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            ...
            <select class="form-select" name="dangerous_goods_regulations">
                <option value="not_applicable" {{ old('dangerous_goods_regulations', 'not_applicable') == 'not_applicable' ? 'selected' : '' }}>
                    {{ __('Not Applicable') }}
                </option>
                <option value="ghs" {{ old('dangerous_goods_regulations') == 'ghs' ? 'selected' : '' }}>GHS</option>
                <option value="storage" {{ old('dangerous_goods_regulations') == 'storage' ? 'selected' : '' }}>Storage</option>
                <option value="transportation" {{ old('dangerous_goods_regulations') == 'transportation' ? 'selected' : '' }}>Transportation</option>
            </select>
        ...
        <div class="col-md-3">
            ...
            <input type="number" step="0.01" class="form-control" name="item_weight" 
                   placeholder="0.0" value="{{ old('item_weight') }}">
        ...
        <div class="col-md-3">
            ...
            <select class="form-select" name="item_weight_unit">
                <option value="grams" {{ old('item_weight_unit', 'grams') == 'grams' ? 'selected' : '' }}>Grams</option>
                <option value="kilograms" {{ old('item_weight_unit') == 'kilograms' ? 'selected' : '' }}>Kilograms</option>
                <option value="pounds" {{ old('item_weight_unit') == 'pounds' ? 'selected' : '' }}>Pounds</option>
                <option value="ounces" {{ old('item_weight_unit') == 'ounces' ? 'selected' : '' }}>Ounces</option>
            </select>
...
<div class="form-section">
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="age_restriction_required" id="age_yes" value="1" {{ old('age_restriction_required') == '1' ? 'checked' : '' }}>
                <label class="form-check-label" for="age_yes">{{ __('Yes') }}</label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="age_restriction_required" id="age_no" value="0" {{ old('age_restriction_required', '0') == '0' ? 'checked' : '' }}>
        ...
        <div class="col-md-6">
            ...
            <input type="email" class="form-control" name="responsible_person_email" 
                   placeholder="{{ __('e.g., rsp-email@example.com') }}" value="{{ old('responsible_person_email') }}">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="special_features" 
                   placeholder="{{ __('e.g., Adjustable, Waterproof') }}" value="{{ old('special_features') }}">
        </div>
    </div>
</div>
