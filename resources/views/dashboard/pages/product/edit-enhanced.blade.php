        ...
        <div class="container-fluid">
            <div class="row mb-4">
                <div class="col-12">
                    ...
                    <p class="text-muted">{{ __('Update product information in the tabs below.') }}</p>
                </div>
            </div>

            <form method="post" action="{{ route('dashboard.products.update', $product->id) }}" enctype="multipart/form-data" id="product-form">
                @csrf
                @method('PUT')
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="tab-content p-4" id="productTabsContent">
                            ...
                            <div class="tab-pane fade show active" id="details" role="tabpanel">
                                @include('dashboard.pages.product.tabs.details-edit', [
                                    'product' => $product,
                            ...
                            <div class="tab-pane fade" id="images" role="tabpanel">
                                @include('dashboard.pages.product.tabs.images-edit', ['product' => $product])
                            </div>

                            <!-- Variations Tab -->
                            <div class="tab-pane fade" id="variations" role="tabpanel">
                                @include('dashboard.pages.product.tabs.variations-edit', ['product' => $product])
                            </div>

                            <!-- Offer Tab -->
                            <div class="tab-pane fade" id="offer" role="tabpanel">
                                @include('dashboard.pages.product.tabs.offer-edit', ['product' => $product])
                            </div>

                            <!-- Safety & Compliance Tab -->
                            <div class="tab-pane fade" id="safety" role="tabpanel">
                                @include('dashboard.pages.product.tabs.safety-edit', ['product' => $product])
                            </div>
                        </div>
                    </div>
                </div>
