    ...
    <div class="main-content">
        <div class="row mb-5">
            <div class="col-12 col-xl-10 mx-auto">
                <form method="post" action="{{ route('dashboard.shipping_policy.update') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="container">
                        <div class="row my-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="description_en" class="form-control" name="description_en"
                                    value="{{ old('description_en', $shipping_policy->description_en ?? '') }}" placeholder="{{ __('Enter description in English') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="description_ar" class="form-control" name="description_ar"
                                    value="{{ old('description_ar', $shipping_policy->description_ar ?? '') }}" placeholder="{{ __('Enter description in Arabic') }}">
