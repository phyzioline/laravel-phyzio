...
<div class="row">
    <div class="col-md-12 mb-4">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('instructor.courses.create') }}" class="btn btn-primary shadow-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="8" class="text-center py-5">
                                    ...
                                    <a href="{{ route('instructor.courses.create') }}" class="btn btn-outline-primary">Create Course</a>
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
